...
// Version     : 1.0
// Description : Programa de teste da classe Hill
//
...
#include <Isotherm/ThreeParameters/Hill.h>                 // ist::Hill
...
typedef     ist::Hill TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 0.362719; 
const Real              QMAX        = 73.3332;    
const Real              K1          = 9.17652;    
const Real              K2          = 7.09033;    
...
const Real                      QEANALIT1(0.6022753316e-2);
