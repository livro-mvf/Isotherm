...
// Version     : 1.0
// Description : Programa de teste da classe Hill da biblioteca isothermlib
//
...
//==============================================================================
// testes da classe Hill
//==============================================================================

int main(int argc, char** argv) {
    
    PrintLine(std::cout);    
    std::cout << "Teste da classe Hill\n";
    PrintLine(std::cout);    
...
ist::Hill   f1;                     // Construtora default
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0);
...
ist::Hill   f2(QMAX, K1, K2);       // Construtora com 3 parametros
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::Hill    f3(f2);             // Construtora de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
...
ist::Hill  f4 = ist::Hill(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::Hill                 var_SP(QMAX_QE, K1_QE, K2_QE);
...
ist::Hill     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);            // Teste ok   
ist::Hill     f61(           0,    K1_Errado,    K2_Errado);            // Teste ok  

ist::Hill     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);            // Teste ok   
ist::Hill     f71(   QMAX_Errado,            0,    K2_Errado);            // Teste ok   

ist::Hill     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);            // Teste ok   
ist::Hill     f81(   QMAX_Errado,            K1_Errado,    1);            // Teste ok    
