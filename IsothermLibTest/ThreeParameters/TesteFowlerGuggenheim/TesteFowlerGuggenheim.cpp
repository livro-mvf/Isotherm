...
////               equações da isoterma de Fowler - Guggenheim.
////
...
//    
//    PrintLine(std::cout);    
//    std::cout << "Teste da classe Fowler - Guggenheim.\n";
//    PrintLine(std::cout);    
//
////==============================================================================
...
//
//ist::FowlerGuggenheim     f1;                 //Construtora default    
//    assert (f1.K1() == 0.0); 
//    assert (f1.K2() == 0.0); 
//    assert (f1.Qmax() == 0.0);
...
//              << std::endl;
//    
//ist::FowlerGuggenheim     f2( QMAX, K1, K2 );     // Construtora com 3 parâmetros; 
//    assert (f2.K1() == K1); 
//    assert (f2.K2() == K2); 
//    assert (f2.Qmax() == QMAX);
//    
...
//              << std::endl;
//
//ist::FowlerGuggenheim     f2a( QMAX, K1, K2, NOVRG );     // Construtora modificando o valor de RGas
//    assert (f2a.K1() == K1); 
//    assert (f2a.K2() == K2); 
...
//              << std::endl;
//
//ist::FowlerGuggenheim     f3(f2);             // Construtoa de cópia
//    assert (f2.K1() == f3.K1()); 
//    assert (f2.K2() == f3.K2()); 
...
//const Real K22 (1.5);
//
//ist::FowlerGuggenheim     f4 = ist::FowlerGuggenheim(QMAX1, K11, K22, NOVRG);
//    assert (f4.K1() == K11); 
//    assert (f4.K2() == K22); 
...
//const ist::FowlerGuggenheim           var_FG(QMAX_QE, K1_QE, K2_QE);
//const Real                      QEANALITICO(0.340898999);
//const Real                      QeNumerico(var_FG.Qe(CE, TEMPK));
...
//
//ist::FowlerGuggenheim     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);            // Teste ok   
//ist::FowlerGuggenheim     f61(           0,    K1_Errado,    K2_Errado);            // Teste ok  
//
//ist::FowlerGuggenheim     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);            // Teste ok   
//ist::FowlerGuggenheim     f71(   QMAX_Errado,            0,    K2_Errado);            // Teste ok   
//
//ist::FowlerGuggenheim     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);            // Teste ok   
//
//    std::cout   << "Imprimindo Qe com C errada = " 
//                << f1.Qe( - CE_Errado ) 
//                << std::endl;                                // Teste ok
//    
//    std::cout   << "Imprimindo Qe com TEMP errada = " 
//                << f1.Qe(   CE_Errado, - TEMPK ) 
//                << std::endl;                                // Teste ok
//    
//ist::FowlerGuggenheim     f9;    
//    
