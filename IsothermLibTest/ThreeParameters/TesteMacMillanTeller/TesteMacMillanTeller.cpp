...
// Version     : 1.0
// Description : Programa de teste da classe MacMillanTeller
//
...
#include <Isotherm/ThreeParameters/MacMillanTeller.h>                 // ist::MacMillanTeller
...
typedef     ist::MacMillanTeller TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.45062;
const Real              QMAX        = 51.2889;    
const Real              K1          = 2.96726;   
const Real              K2          = 2.90583;    
...
const Real                      QEANALIT1(3996.186602);
