...
#include <Isotherm/ThreeParameters/ViethSladek.h>                 // ist::ViethSladek
...
typedef     ist::ViethSladek TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.47549;
const Real              QMAX        = 7.51932;    
const Real              K1          = 0.0309101;   
const Real              K2          = 0.0235572;    
...
const Real                      QEANALIT1(.3627377929);
