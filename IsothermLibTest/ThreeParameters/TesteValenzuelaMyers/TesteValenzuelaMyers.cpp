...
#include <Isotherm/ThreeParameters/ValenzuelaMyers.h>                 // ist::ValenzuelaMyers
...
typedef     ist::ValenzuelaMyers TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.00714;
const Real              QMAX        = 54.8240;    
const Real              K1          = 0.492822e-1;   
const Real              K2          = 0.926737e-1;    
...
const Real                      QEANALIT1(52.26328980);
