...
#include <Isotherm/ThreeParameters/RadkePrausnitsII.h>                 // ist::RadkePrausnitsII
...
typedef     ist::RadkePrausnitsII TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.10981;
const Real              QMAX        = 18.6634;    
const Real              K1          = 1.91479;   
const Real              K2          = 2.73215;    
...
const Real                      QEANALIT1(11.18669122);
