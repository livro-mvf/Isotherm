...
#include <Isotherm/ThreeParameters/Unilan.h>                 // ist::Unilan
...
typedef     ist::Unilan TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.29208;
const Real              QMAX        = 96.4634;    
const Real              K1          = 3.32592;   
const Real              K2          = 0.301917;    
...
const Real                      QEANALIT1(78.11450925);
