...
// Version     : 1.0
// Description : Programa de teste da classe KobleCorrigan
//
...
#include <Isotherm/ThreeParameters/KobleCorrigan.h>                 // ist::KobleCorrigan
...
typedef     ist::KobleCorrigan TestIsotherm;
