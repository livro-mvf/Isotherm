...
#include <Isotherm/ThreeParameters/Toth.h>                 // ist::Toth
...
typedef     ist::Toth TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.12596;
const Real              QMAX        = 47.0956;    
const Real              K1          = 0.307156;   
const Real              K2          = 0.155428;    
...
const Real                      QEANALIT1(0.4630459181e-2);
