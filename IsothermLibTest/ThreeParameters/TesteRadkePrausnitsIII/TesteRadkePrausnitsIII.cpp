...
#include <Isotherm/ThreeParameters/RadkePrausnitsIII.h>                 // ist::RadkePrausnitsIII
...
typedef     ist::RadkePrausnitsIII TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.50068;
const Real              QMAX        = 9.54362;    
const Real              K1          = 8.23620;   
const Real              K2          = 2.40169;    
...
const Real                      QEANALIT1(13.40082673);
...
TEST_F(TestSuit, DeathTest) {
    ...
    EXPECT_DEATH(TestIsotherm(  QMAX ,    K1, - K2);, "");
    EXPECT_DEATH(TestIsotherm(  QMAX ,    K1, 1.0);, "");
    EXPECT_DEATH(isotherm_2.K2( - K2);, "");
    EXPECT_DEATH(isotherm_2.K2(  1.0);, "");
