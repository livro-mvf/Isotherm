//==============================================================================
// Name        : TesteRadkePrausnitsIII.cpp
// Authors     : Lara Botelho Brum
//               Luan Rodrigues Soares de Souza
//               Joao Flavio Vieira de Vasconcellos
// Version     : 1.0
// Description : Programa de teste da classe Radke-Prausnits III da biblioteca isothermlib
//
...
//==============================================================================
// testes da classe Radke - Prausnits III
//==============================================================================

int main(int argc, char** argv) {
    
    PrintLine(std::cout);    
    std::cout << "Teste da classe Radke-Prausnits III\n";
    PrintLine(std::cout);    
...
ist::RadkePrausnitsIII   f1;                     // Construtora default
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0);
...
ist::RadkePrausnitsIII   f2(QMAX, K1, K2);       // Construtora com 3 parametros
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::RadkePrausnitsIII    f3(f2);             // Construtora de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
...
ist::RadkePrausnitsIII  f4 = ist::RadkePrausnitsIII(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::RadkePrausnitsIII     var_SP(QMAX_QE, K1_QE, K2_QE);
...
ist::RadkePrausnitsIII     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);             
ist::RadkePrausnitsIII     f61(             0,    K1_Errado,    K2_Errado);           

ist::RadkePrausnitsIII     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);              
ist::RadkePrausnitsIII     f71(   QMAX_Errado,            0,    K2_Errado);               

ist::RadkePrausnitsIII     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);               
ist::RadkePrausnitsIII     f81(   QMAX_Errado,    K1_Errado,            1);              

    std::cout   << "Imprimindo Qe com C errada = " 
                << f1.Qe( - CE_Errado ) 
                << std::endl;                                
    
ist::RadkePrausnitsIII     f9;    
