...
#include <Isotherm/ThreeParameters/RedlichPeterson.h>                 // ist::RedlichPeterson
...
typedef     ist::RedlichPeterson TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.35757;
const Real              K1          = 3.88568;   
const Real              K2          = 2.76281;    
const Real              K3          = 0.00454748;    
const Real              K1Novo      = 98.1e-03;    
const Real              K2Novo      = 3.3;    
const Real              K3Novo      = 0.443;    

public:
        
    TestIsotherm     isotherm_1;    
    TestIsotherm     isotherm_2 = TestIsotherm(K1, K2, K3);    
...
const Real                      QEANALIT1(1.400469344);
const TestIsotherm              iso1 (K1, K2, K3);
...
TEST_F(TestSuit, DeathTest) {
    ...
    EXPECT_DEATH(TestIsotherm(-K1, K2, K3);, ""); 
    EXPECT_DEATH(TestIsotherm(0.0, K2, K3);, "");
    EXPECT_DEATH(isotherm_2.K1(- K1);, "");
    EXPECT_DEATH(isotherm_2.K1(   0.0);, "");


    EXPECT_DEATH(TestIsotherm(K1, -K2, K3);, ""); 
    EXPECT_DEATH(TestIsotherm(K1, 0.0, K3);, "");
    EXPECT_DEATH(isotherm_2.K2(- K2);, "");
    EXPECT_DEATH(isotherm_2.K2(   0.0);, "");

    EXPECT_DEATH(TestIsotherm(K1, K2, -K3);, ""); 
    EXPECT_DEATH(TestIsotherm(K1, K2, 0.0);, "");
    EXPECT_DEATH(TestIsotherm(K1, K2, 1.0);, "");
    EXPECT_DEATH(isotherm_2.K3(- K2);, "");
    EXPECT_DEATH(isotherm_2.K3(   0.0);, "");
    EXPECT_DEATH(isotherm_2.K3(   1.0);, "");
