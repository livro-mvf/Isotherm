...
// Version     : 1.0
// Description : Programa de teste da classe LangmuirJovanovic
//
...
#include <Isotherm/ThreeParameters/LangmuirJovanovic.h>                 // ist::LangmuirJovanovic
...
typedef     ist::LangmuirJovanovic TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.01269;
const Real              QMAX        = 4.81382;    
const Real              K1          = 1.46416;   
const Real              K2          = 0.812867;    
...
const Real                      QEANALIT1(1.870311375);
