...
#include <Isotherm/ThreeParameters/Sips.h>                 // ist::Sips
...
typedef     ist::Sips TestIsotherm;

class TestSuit : public ::testing::Test {  
    
protected: 
    
const Real              CE          = 1.79986;
const Real              QMAX        = 3.26828;    
const Real              K1          = 0.910566;   
const Real              K2          = 0.0237895;    
...
const Real                      QEANALIT1(3.268279997);
