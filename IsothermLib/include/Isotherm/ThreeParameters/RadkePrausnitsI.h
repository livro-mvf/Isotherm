...
//#define __RADKE_PRAUSNITS_I_DEBUG_H__
...
/// @endcode
/// </example>
/// @param  _orig Variável do tipo Radke - Prausnits I original.
...
/// <summary>
/// Construtora com os parâmetros que definem a isoterma de RadkePrausnitsI.
/// </summary>
/// <example>
/// Uso:
/// @code
...
///  @exception _c < 0.
    ...
    [[nodiscard]] 
    virtual RadkePrausnitsI* CloneImplementation() const override
    {
        return new RadkePrausnitsI(*this);
    }
