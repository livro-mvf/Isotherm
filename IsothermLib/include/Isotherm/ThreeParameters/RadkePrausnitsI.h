...
#ifndef __RADKE_PRAUSNITS_I_H__
#define __RADKE_PRAUSNITS_I_H__
...
///\begin{align}
///  \[Q_e(C_e,T)= q_{max}[\frac{K_1C_e}{(1+K_1C_e)^{K_2}}]\]
///\end{align}
...
class RadkePrausnitsI :  public virtual ThreeParameters,
              public IsothermTemplate < RadkePrausnitsI > {
...
/// <example>
    ...
    DefineIdentity("Radke - Prausnits I", ID::RadkePrausnitsI);
...
/// @endcode
/// </example>
/// @param  _orig Variavel do tipo Radke - Prausnits I original.
    RadkePrausnitsI (const RadkePrausnitsI& _radke_prausnits_i) = default;

/// <summary>
/// Destrutora.
/// </summary>
    virtual ~RadkePrausnitsI() = default;

/// <summary>
/// Construtora com os parametros que definem a isoterma de RadkePrausnitsI.
/// </summary>
/// <example>
/// Uso:
/// @code
...
///     double K1(1.0);
///     double K2(1.0);
///     RadkePrausnitsI  var1(Q1, K1, K2);
/// @endcode
/// </example>
///  @param _qmax Capacidade maxima de adsorcao.
///  @param  _k1 Constante da isortema de Radke - Prausnits I.
///  @param _k2 Constante da isoterma de Radke - Prausnits I.
///  @exception _qmax <= 0.
///  @exception _k1 <= 0.
///  @exception _k2 <= 0.
    RadkePrausnitsI (const Real&, const Real&, const Real&);
...
///  @return Copia de _orig.
    RadkePrausnitsI& operator = (const RadkePrausnitsI&) = default;
...
/// </example>
///  @param " " Nao ha parametros.
///  @return Valor do parametro da equacao de Radke - Prausnits I.
[[nodiscard]]
...
///  @exception _qmax <= 0.
    void Qmax (const Real& _qmax)  {*this = RadkePrausnitsI (_qmax, Value(1), Value(2));};
...
/// @endcode
/// </example>
///  @param _k1 Novo valor do coeficiente associado a constante da isoterma de Radke - Prausnits I.
///  @exception _k1 <= 0.
    void K1 (const Real& _k1)  {*this = RadkePrausnitsI (Value(0), _k1, Value(2));};
...
/// @endcode
/// </example>
///  @param _k2 Novo valor associado a constante da isoterma de Radke - Prausnits I.
///  @exception _k2 <= 0.
    void K2 (const Real& _k2)  {*this = RadkePrausnitsI(Value(0), Value(1), _k2);};
...
///  @exception _c < 0.
    ...
    {
        return std::make_unique<RadkePrausnitsI>(*this);
    }
