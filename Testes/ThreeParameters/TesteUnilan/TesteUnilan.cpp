...
//==============================================================================
    ...
    PrintLine(std::cout);    
    std::cout << "Teste da classe Unilan\n";
    PrintLine(std::cout);    
...
ist::Unilan     f1;                 //Construtora default    
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0); 
...
ist::Unilan     f2( QMAX, K1, K2 );     // Construtora com 3 parâmetros; 
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::Unilan     f3(f2);             // Construtoa de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
...
ist::Unilan     f4 = ist::Unilan(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::Unilan           var_U(QMAX_QE, K1_QE, K2_QE);
const Real                      QEANALITICO(0.34052986);
const Real                      QeNumerico(var_U.Qe(CE));
...
ist::Unilan     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);            // Teste ok   

ist::Unilan     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);            // Teste ok   

ist::Unilan     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);            // Teste ok   
