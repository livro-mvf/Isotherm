...
//               equações da isoterma de Brunauer - Emmett - Teller.
//
...
//==============================================================================
    ...
    PrintLine(std::cout);    
    std::cout << "Teste da classe Brunauer - Emmett - Teller\n";
    PrintLine(std::cout);    
...
ist::BrunauerEmmettTeller     f1;                 //Construtora default    
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0); 
...
ist::BrunauerEmmettTeller     f2( QMAX, K1, K2 );     // Construtora com 3 parâmetros; 
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::BrunauerEmmettTeller     f3(f2);             // Construtoa de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
...
ist::BrunauerEmmettTeller     f4 = ist::BrunauerEmmettTeller(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::BrunauerEmmettTeller           var_BET(QMAX_QE, K1_QE, K2_QE);
const Real                      QEANALITICO(-0.210349039);
const Real                      QeNumerico(var_BET.Qe(CE));
...
ist::BrunauerEmmettTeller     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);            // Teste ok   

ist::BrunauerEmmettTeller     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);            // Teste ok   

ist::BrunauerEmmettTeller     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);            // Teste ok   

    std::cout   << "Imprimindo Qe com C errada = " 
                << f1.Qe( - CE_Errado ) 
                << std::endl;                                // Teste ok
    
ist::BrunauerEmmettTeller     f9;    
