//==============================================================================
// Name        : TesteHollKrich.cpp
// Authors     : Iasmim Barboza Storck
//               Lara Botelho Brum
//               Luan Rodrigues Soares de Souza
//               Joao Flavio Vieira de Vasconcellos
// Version     : 1.0
// Description : Programa de teste da classe Holl-Krich da biblioteca isothermlib
//
...
//==============================================================================
// testes da classe Holl-Krich
//==============================================================================

int main(int argc, char** argv) {
    
    PrintLine(std::cout);    
    std::cout << "Teste da classe Holl-Krich\n";
    PrintLine(std::cout);    
...
ist::HollKrich     f1;                 //Construtora default    
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0);
...
ist::HollKrich   f2(QMAX, K1, K2);       // Construtora com 3 parametros
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::HollKrich    f3(f2);             // Construtora de cópia
    assert (f2.K1()   == f3.K1()); 
    assert (f2.K2()   == f3.K2()); 
...
ist::HollKrich  f4 = ist::HollKrich(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::HollKrich                 var_SP(QMAX_QE, K1_QE, K2_QE);
...
ist::HollKrich           graph(QG , KG1, KG2);  
...
ist::HollKrich     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);             
ist::HollKrich     f61(           0,      K1_Errado,    K2_Errado);              

ist::HollKrich     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);             
ist::HollKrich     f71(   QMAX_Errado,            0,    K2_Errado);            

ist::HollKrich     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);             
ist::HollKrich     f81(   QMAX_Errado,    K1_Errado,    1);              
