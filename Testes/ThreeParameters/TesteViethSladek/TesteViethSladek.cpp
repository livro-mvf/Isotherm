...
//==============================================================================
    ...
    PrintLine(std::cout);    
    std::cout << "Teste da classe Vieth-Sladek\n";
    PrintLine(std::cout);    
...
ist::ViethSladek     f1;                 //Construtora default    
    assert (f1.K1() == 0); 
    assert (f1.K2() == 0); 
    assert (f1.Qmax() == 0); 
...
ist::ViethSladek     f2( QMAX, K1, K2 );     // Construtora com 3 parâmetros; 
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.Qmax() == QMAX);
...
ist::ViethSladek     f3(f2);             // Construtoa de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
...
ist::ViethSladek     f4 = ist::ViethSladek(QMAX1, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
...
const ist::ViethSladek           var_VS(QMAX_QE, K1_QE, K2_QE);
const Real                      QEANALITICO(0.720429285);
const Real                      QeNumerico(var_VS.Qe(CE));
...
ist::ViethSladek     f6 ( - QMAX_Errado,    K1_Errado,    K2_Errado);            // Teste ok   

ist::ViethSladek     f7 (   QMAX_Errado,  - K1_Errado,    K2_Errado);            // Teste ok   

ist::ViethSladek     f8 (   QMAX_Errado,    K1_Errado,  - K2_Errado);            // Teste ok   
