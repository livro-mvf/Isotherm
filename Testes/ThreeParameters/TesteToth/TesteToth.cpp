...
// Version     : 1.0
// Description : Programa de teste da classe Toth da biblioteca isothermlib
//
...
//==============================================================================
// testes da classe Toth
//==============================================================================

int main(int argc, char** argv) {
    
    PrintLine(std::cout);    
    std::cout << "Teste da classe Toth\n";
    PrintLine(std::cout);    
...
ist::Toth   f2(K3, K1, K2);       // Construtora com 3 parametros
    assert (f2.K1() == K1); 
    assert (f2.K2() == K2); 
    assert (f2.K3() == K3);
...
ist::Toth    f3(f2);             // Construtora de cópia
    assert (f2.K1() == f3.K1()); 
    assert (f2.K2() == f3.K2()); 
    assert (f2.K3() == f3.K3());
...
const Real K33 (778.0);
const Real K11 (45.);
const Real K22 (1.5);

ist::Toth  f4 = ist::Toth(K33, K11, K22);
    assert (f4.K1() == K11); 
    assert (f4.K2() == K22); 
    assert (f4.K3() == K33);
...
const ist::Toth                 var_SP(K3_QE, K1_QE, K2_QE);
...
ist::Toth     f6 ( - K3_Errado,    K1_Errado,    K2_Errado);             
ist::Toth     f61(           0,    K1_Errado,    K2_Errado);              

ist::Toth     f7 (   K3_Errado,  - K1_Errado,    K2_Errado);             
ist::Toth     f71(   K3_Errado,            0,    K2_Errado);            

ist::Toth     f8 (   K3_Errado,    K1_Errado,  - K2_Errado);             
ist::Toth     f81(   K3_Errado,            K1_Errado,    1);              
